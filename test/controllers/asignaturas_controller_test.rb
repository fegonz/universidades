...
class AsignaturasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create asignatura" do
    assert_difference('Asignatura.count') do
      post asignaturas_url, params: { asignatura: { creditos: @asignatura.creditos, grado_id: @asignatura.grado_id, nombre: @asignatura.nombre, tipo: @asignatura.tipo } }
    end
  ...
  test "should update asignatura" do
    patch asignatura_url(@asignatura), params: { asignatura: { creditos: @asignatura.creditos, grado_id: @asignatura.grado_id, nombre: @asignatura.nombre, tipo: @asignatura.tipo } }
