...
class UniversidadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create universidad" do
    assert_difference('Universidad.count') do
      post universidads_url, params: { universidad: { comunidad_id: @universidad.comunidad_id, nombre: @universidad.nombre, tipo: @universidad.tipo, url: @universidad.url } }
    end
  ...
  test "should update universidad" do
    patch universidad_url(@universidad), params: { universidad: { comunidad_id: @universidad.comunidad_id, nombre: @universidad.nombre, tipo: @universidad.tipo, url: @universidad.url } }
